import 'package:cric8hemant/api/pincodeapi.dart';
import 'package:cric8hemant/const/const.dart';
import 'package:cric8hemant/const/user_cred.dart';
import 'package:flutter/material.dart';
import 'package:geolocator/geolocator.dart';
// import 'package:krayvikray/api/pincodeapi.dart';
// import 'package:krayvikray/bloc/user_cred.dart';
      ...
      if (pincode.length > 0) {
        Future.delayed(Duration(seconds: 2), () {
          Navigator.of(context)
              .pushNamedAndRemoveUntil('/boot', ModalRoute.withName('/'));
        });
      } else {}
